...
import com.hrms.offers.dto.JobOfferDto;
...
final class OfferCsvExporter {
    ...
    static String toCsv(List<JobOfferDto> rows) {
        ...
        for (JobOfferDto o : rows) {
            sb.append(csv(o.id()))
                    ...
                    .append(',').append(csv(o.joinDate() != null ? o.joinDate().toString() : null))
                    ...
                    .append(',').append(csv(o.annualCtc() != null ? o.annualCtc().toPlainString() : null))
                    .append(',').append(csv(o.currency()))
